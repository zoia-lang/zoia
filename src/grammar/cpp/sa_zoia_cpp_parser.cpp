...
PyObject* do_parse(PyObject *self, PyObject *args) {
    ...
    try {
        ...
        // Parse
        zoiaParser parser(&token_stream);
        if(sa_err_listener != Py_None){
        ...
        SA_zoiaTranslator visitor(&translator);
...
extern "C" {
    ...
    static struct PyModuleDef module = {
        ...
        "sa_zoia_cpp_parser",   /* name of module */
...
PyMODINIT_FUNC
PyInit_sa_zoia_cpp_parser(void) {
