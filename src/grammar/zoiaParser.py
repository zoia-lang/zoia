...
class zoiaParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>",
                      ...
                      "<INVALID>", "COMMENT", "Newline", "Space", "Char" ]
    ...
    ruleNames =  [ "zoiaFile", "header", "line", "lineElement", "textFragment",
    ...
    def zoiaFile(self):
        ...
        try:
            ...
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << zoiaParser.T__1) | (1 << zoiaParser.T__2) | (1 << zoiaParser.Newline) | (1 << zoiaParser.Space) | (1 << zoiaParser.Char))) != 0):
                self.state = 27
                self.line()
                self.state = 32
                self._errHandler.sync(self)
    ...
    def line(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << zoiaParser.T__1) | (1 << zoiaParser.T__2) | (1 << zoiaParser.Space) | (1 << zoiaParser.Char))) != 0):
                self.state = 39
                self.lineElement()
                self.state = 44
                self._errHandler.sync(self)
    ...
    def textFragment(self):
        ...
        self.enterRule(localctx, 8, self.RULE_textFragment)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 54
            self._errHandler.sync(self)
    ...
    def kwdArgument(self):
        ...
        self.enterRule(localctx, 20, self.RULE_kwdArgument)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 122
    ...
    def whitespace(self):
        ...
        self.enterRule(localctx, 24, self.RULE_whitespace)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 147
